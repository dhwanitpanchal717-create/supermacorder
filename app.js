  ...
  state.orders = [
    {
      ...
      contactPerson:"", mobile:"", alternateMobile:"", location:"Ahmedabad", address:"",
      machineType:"Toggle Type", machineModel:"SM-125", tonnage:"", plc:"Keba", plcModel:"",
      servoType:"Inovance", servoSize:"15 kW", screwType:"Standard", screwSize:"45 mm", barrelType:"Dia 95 x 30 x 938mm",
      motorHP:"15 HP", pumpType:"", tieBarDistance:"Std", corePull:"",
      ejector:"", deliveryDate:todayISO(), status:"Confirmed", priority:"High",
...
function getFilteredOrders(){
  ...
  return state.orders.filter(o => {
    const haystack = [
      o.orderID, o.buyerName, o.companyName, o.location,
...
function getFormData(){
  ...
  // Safely auto-fill legacy missing required cell properties to prevent database pipeline crashes
